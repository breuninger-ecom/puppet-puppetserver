...
describe provider_class do
  context "with empty file" do
    ...
    skip "should create simple new entry" do
    ...
    skip "should create an array entry" do
      apply!(Puppet::Type.type(:puppetserver_config).new(
        :name     => "foo",
        :key      => "foo",
        :path     => "bar",
  ...
  context "with full file" do
    ...
    describe "when creating settings" do
      skip "should create a simple entry" do
        apply!(Puppet::Type.type(:puppetserver_config).new(
          :name     => "foo",
          :key      => "foo",
          :path     => "bar",
    ...
    describe "when deleting settings" do
      skip "should delete a setting" do
        apply!(Puppet::Type.type(:puppetserver_config).new(
    ...
    describe "when updating settings" do
      skip "should replace a setting" do
        apply!(Puppet::Type.type(:puppetserver_config).new(
          :name     => "client-whitelist",
          :key      => "client-whitelist",
          :path     => "puppet-admin",
